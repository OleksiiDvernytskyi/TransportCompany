...
@NamedQueries({
    ...
    @NamedQuery(name = "Order.getArchiveOrders",
            query = "SELECT o FROM Order o WHERE o.phone LIKE :phone AND ( o.status ='Complete' OR o.status ='CANCELED') ORDER BY o.date DESC "),
    ...
    @NamedQuery(name = "Order.getArchivePagesCount", 
            query = "SELECT COUNT(o) FROM Order o WHERE o.phone LIKE :phone AND ( o.status ='Complete' OR o.status ='CANCELED') ORDER BY o.date DESC ")
})
